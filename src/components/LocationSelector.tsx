...
export default function LocationSelector({ isOpen, onClose }: LocationSelectorProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[50] flex items-center justify-center p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[70vh] my-8 overflow-hidden flex flex-col transform animate-in fade-in-0 zoom-in-95 duration-300">
