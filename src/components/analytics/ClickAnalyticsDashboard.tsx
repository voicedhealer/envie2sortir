        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-green-50 rounded-lg p-4">
            ...
            <div className="text-sm text-green-800 font-medium">
              {data.topElements.length > 0 && data.topElements[0].elementName 
                ? data.topElements[0].elementName 
                : 'Action la plus utilisée'}
            </div>
            <div className="text-xs text-green-600 mt-1">
              {data.topElements.length > 0 && data.topElements[0].elementName
                ? `Interactions sur "${data.topElements[0].elementName}"`
                : 'Interaction la plus fréquente'}
            </div>
          </div>
                      ...
                      <div>
                        <div className="font-medium text-gray-900 capitalize">
                          {type.elementType === 'link' ? 'Liens externes' :
                           ...
                           type.elementType === 'button' ? 'Actions rapides' :
                           type.elementType === 'contact' ? 'Moyens de contact' :
                           type.elementType}
                        </div>
                        <div className="text-sm text-gray-500">
                          {type.elementType === 'link' ? 'Réseaux sociaux, site web' :
                           ...
                           type.elementType === 'button' ? 'Itinéraire, favoris, partage, menu' :
                           type.elementType === 'contact' ? 'Appel, WhatsApp, Messenger, email' :
                           'Contenu interactif'}
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="text-sm text-blue-700 mt-1">
                          Les <strong>
                            {topType.elementType === 'link' ? 'liens externes' :
                             ...
                             topType.elementType === 'button' ? 'actions rapides' :
                             topType.elementType === 'contact' ? 'moyens de contact' :
                             topType.elementType}
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  <div className="bg-green-50 rounded-lg p-3 border border-green-200">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium text-green-800">Ultra envie</span>
                  ...
                  <div className="bg-blue-50 rounded-lg p-3 border border-blue-200">
                    <div className="flex items-center justify-between mb-1">
                      <span className="text-sm font-medium text-blue-800">Intrigué</span>
                            ...
                            <div className="flex-1">
                              ...
                              <div className="grid grid-cols-4 gap-2 ml-8">
                                <div className="text-center">
                                  ...
                                  <div className="text-xs text-gray-500">Ultra envie</div>
                                </div>
                                <div className="text-center">
                                  <div className="text-sm font-semibold text-blue-600">{event.stats.decouvrir}</div>
                                  <div className="text-xs text-gray-500">Intrigué</div>
                                </div>
                                <div className="text-center">
